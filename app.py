...
# 3. Fonction pour charger le fichier JSON local
...
def afficher_page_hamza():
    ...
    with head_col2:
        lottie_json = load_lottiefile("animation.json")
        if lottie_json:
            st_lottie(lottie_json, height=150, key="pen_animation")
        else:
